        ...
        <div class="container">
          <div class="footer-grid">
            <div class="footer-col">
              <a class="brand" href="${SITE_ROOT}" style="margin-bottom:14px;"><span class="brand-mark"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M6 2h9l5 5v15a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1Z" stroke="currentColor" stroke-width="1.8"/></svg></span>PDF Ultra Pro</a>
          ...
          <div class="footer-contact" style="margin:24px 0 18px;padding:18px 22px;border-radius:18px;background:linear-gradient(135deg,rgba(108,76,240,.12),rgba(62,224,232,.12));border:1px solid rgba(108,76,240,.25);box-shadow:0 8px 28px rgba(108,76,240,.10);"><strong style="font-size:1rem;">Need help?</strong><a href="tel:+919648660720" style="display:inline-block;margin:5px 8px;padding:7px 13px;border-radius:999px;background:linear-gradient(135deg,#6C4CF0,#3EE0E8);color:#fff;font-weight:800;">📞 +91 96486 60720</a><a href="mailto:abhishekv8471@gmail.com" style="display:inline-block;margin:5px 8px;padding:7px 13px;border-radius:999px;background:linear-gradient(135deg,#3EE0E8,#6C4CF0);color:#fff;font-weight:800;">✉️ abhishekv8471@gmail.com</a></div>
          <div class="footer-bottom"><span>© ${year} PDF Ultra Pro. All files are processed locally in your browser.</span><span class="creator-credit">✦ Made by Abhishek · Crafted with care to keep your PDFs private, simple and powerful. ✦</span></div>
        </div>
      </footer>`;
  }

  function loadCloudflareAnalytics() {
    if (window.__pdfUltraCloudflareAnalyticsLoaded || document.querySelector('script[data-pdf-ultra-cloudflare-analytics]')) return;
    const script = document.createElement('script');
    script.type = 'module';
    script.src = 'https://static.cloudflareinsights.com/beacon.min.js';
    script.setAttribute('data-cf-beacon', JSON.stringify({ token: '3a9a4d73a00f4683b7cac2895486af90' }));
    script.setAttribute('data-pdf-ultra-cloudflare-analytics', 'true');
    document.body.appendChild(script);
    window.__pdfUltraCloudflareAnalyticsLoaded = true;
  }
